function fullPage() {
    $("#js-fullpage").fullpage({
        ...
        scrollingSpeed: 1e3,
        anchors: ["top", "about", "project", "certificate", "contact"],
        navigation: !0,
        ...
        (entries) => {
            entries.forEach((entry) => {
                if (!entry.isIntersecting) {
                    navbar.classList.add("scrolled"); // Tambah kelas saat keluar dari hero
                } else {
                    navbar.classList.remove("scrolled"); // Hapus kelas saat di hero
                }
            });
        },
        { threshold: 0.1 }
